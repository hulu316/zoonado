# -*- coding: utf-8 -*-
#
# zoonado documentation build configuration file, created by
...
project = u'zoonado'
copyright = u'2016, William Glass'
...
version = release = zoonado.__version__
...
extlinks = {
    "current_tarball": (
        "https://pypi.python.org/packages/source/z/zoonado/" +
        "zoonado-%s.tar.g%%s" % version,
        "zoonado-%s.tar.g" % version
    )
}
